...
{
  Send_cmd(0x0F,folder,track); //0x0F запуск определенного трека c определенной папки первый параметр номер папки второй трека
}

void DF_PlayFromStart(void)
{
  Send_cmd(0x03,0x00,0x01); //0x03 запуск определенного трека 
}
